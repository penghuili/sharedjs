export const sharedActionTypes = {
  ...
  IS_DELETING_ACCOUNT: 'shared/IS_DELETING_ACCOUNT',
...
export const sharedActionCreators = {
  ...
  signUpPressed(username, email, password) {
    return { type: sharedActionTypes.SIGN_UP_PRESSED, payload: { username, email, password } };
  },
  signInPressed(username, email, password) {
    return { type: sharedActionTypes.SIGN_IN_PRESSED, payload: { username, email, password } };
  },
  ...
  isDeletingAccount(value) {
    return { type: sharedActionTypes.IS_DELETING_ACCOUNT, payload: { value } };
  },
