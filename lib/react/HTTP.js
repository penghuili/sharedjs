...
const serverToUrl = {
  ...
  [apps.favicon.name]: process.env.REACT_APP_FAVICON_API_URL,
  [apps.file37.name]: process.env.REACT_APP_FILE37_API_URL,
  [apps.friend37.name]: process.env.REACT_APP_FRIEND37_API_URL,
  [apps.group37]: process.env.REACT_APP_GROUP37_API_URL,
  ...
  [apps.pdf37.name]: process.env.REACT_APP_PDF37_API_URL,
  [apps.puppeteer]: process.env.REACT_APP_PUPPETEER_API_URL,
  [apps.schedule]: process.env.REACT_APP_SCHEDULE_API_URL,
  [apps.sharefile.name]: process.env.REACT_APP_SHAREFILE_API_URL,
  [apps.static37]: process.env.REACT_APP_STATIC37_API_URL,
